...
echo "<div class='paragraph-row'>
	...
	<div class='column4 hidden-xs'>
		<div class='paragraph-row'>
			<div class='column12'>
				<a target='_BLANK' href='https://bit.ly/3zYT4JO'><img src='".base_url()."asset/foto_iklanatas/$ik1[gambar]' style='width:100%; height: 190px;'></a>
			</div>
		</div>
		<div class='paragraph-row'>
			<div class='column6' style='margin-top:10px'>
				<a target='_BLANK' href='https://bit.ly/3zYT4JO'><img src='".base_url()."asset/foto_iklanatas/$ik2[gambar]' style='width:100%; height: 180px;'></a>
			</div>
			<div class='column6' style='margin-top:10px'>
				<a target='_BLANK' href='https://bit.ly/3zYT4JO'><img src='".base_url()."asset/foto_iklanatas/$ik3[gambar]' style='width:100%; height: 180px;'></a>
			</div>
		</div>
	</div>
	<div class='column2 hidden-xs'>
		<a target='_BLANK' href='https://bit.ly/3zYT4JO'><img src='".base_url()."asset/foto_iklanatas/$ik4[gambar]' style='width:100%; min-height: 380px;'></a>
	</div>
</div>
<br>
